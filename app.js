while (!player1){
    var player1 = prompt('Player One: Adja meg a nevét. Öné lesz a piros szín.');
};
var player1Color = 'red';

while (!player2){
    var player2 = prompt('Player Two: Adja meg a nevét. Öné lesz a sárga szín.');
};
...
let rules = document.querySelector('.info');
